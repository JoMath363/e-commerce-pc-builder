...
const EmptyCart = () => {
  return (
    <div className="w-full flex flex-col text-center gap-4 m-auto p-6 rounded-xl bg-[var(--surface)]">
      ...
      <Link to="/" className="px-4 py-2 flex justify-center items-center gap-2 bg-[var(--primary-2)] text-[var(--background)] rounded hover:bg-[var(--primary-1)] active:bg-[var(--secondary-1)]">
        <p className="">
          Browse Products
        </p>
        <PiCaretRightBold />
